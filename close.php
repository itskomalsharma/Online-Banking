<?php
	...
	{
		mysqli_query($a,"delete from abc WHERE accountno='".$_POST['accountno']."' and username='".$_POST['email']."' and password='".$_POST['password']."'");
...
<br>
<center><h1 style="color:black;font-family:Adobe Garamond Pro Bold;">CLOSE ACCOUNT FORM</h1></center>
...
<br><form action="" method="post" style="width:%;margin-left:30px;margin-right:30px;">
		...
		<br><input class="btn btn-primary btn-block"type="submit" name="submit" value="Close"style="color:white;">
</form>
</div>